...
import 'package:fe_lab_clinicas_self_service_cb/src/modules/self_service/patient_page/patient_router.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  Map<String, WidgetBuilder> get pages => {
        ...
        '/documents/confirm': (context) => const DocumentsScanConfirmRouter(),
