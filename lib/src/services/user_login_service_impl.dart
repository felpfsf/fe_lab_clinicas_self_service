...
class UserLoginServiceImpl implements UserLoginService {
  ...
  Future<Either<ServiceException, Unit>> execute(
    ...
    switch (loginResult) {
      // Trata essas duas possibilidades de erro, qualquer outro erro desconhecido seria levado para um analytics
      // Após isso temos que armazenar o accessToken no localStorage do aparelho
      ...
      case Left(value: AuthUnauthorizedException()):
        return Left(ServiceException(message: 'Senha ou usuário inválido'));
